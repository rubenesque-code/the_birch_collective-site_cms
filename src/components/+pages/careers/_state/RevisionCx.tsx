...
function Provider({
  ...
  const page = UedCx.Pages.Careers.use();
  ...
  const { revision: careers } = UedCx.Careers.use();
  ...
  const saveMutation = useMutation(myDb.transactions.pages.careers);
