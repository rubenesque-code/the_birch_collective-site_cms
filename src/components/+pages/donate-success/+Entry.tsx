...
type PageDbData = {
  page: MyDb["pages"]["donate-success"];
};
...
const usePageSpecificDbDataInit = () => {
  const pageQuery = useQuery(
    "donate-success",
    myDb.pages["donate-success"].fetch,
  );
...
const PageUserEditProviders = ({
  ...
  <UedCx.Pages.DonateSuccess.Provider initData={dbData.page}>
    {children}
  </UedCx.Pages.DonateSuccess.Provider>
);
