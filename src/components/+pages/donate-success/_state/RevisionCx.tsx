...
function Provider({
  ...
  const page = UedCx.Pages.DonateSuccess.use();
  ...
  const saveMutation = useMutation(myDb.transactions.pages["donate-success"]);
      ...
      toast.promise(
        () =>
          saveMutation.mutateAsync(
            {
              page: { id: "donate-success-page", ...page.revision.saveData },
