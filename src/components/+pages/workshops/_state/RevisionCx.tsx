...
function Provider({
  ...
  const page = UedCx.Pages.Workshops.use();
  ...
  const { revision: workshops } = UedCx.Workshops.use();
  ...
  const saveMutation = useMutation(myDb.transactions.pages.workshops);
      ...
      toast.promise(
        () =>
          saveMutation.mutateAsync(
            {
              page: { id: "workshops-page", ...page.revision.saveData },
