...
type Testimonial = MyDb["professional-testimonial"];

type ActionFields = MyPick<
  Testimonial,
  "endorserName" | "image" | "text" | "endorserTitle"
>;
  ...
  return z.createStore<Store>()((set) => {
    ...
    return {
      ...
      actions: {
        ...
        endorserTitle: nonArrAction("endorserTitle"),
...
function Provider({
  ...
  const isUserEntry = Boolean(
    store.data.endorserName.length ||
      store.data.endorserTitle.length ||
