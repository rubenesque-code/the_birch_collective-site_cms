...
function useContext() {
  ...
  if (!context) throw new Error("Missing CareersDataCx.Provider in the tree");

  return context;
}

function CareersDataCx() {
  throw new Error(
    "CareersDataCx exists for naming purposes only and should not be used as a component",
  );
}

export { CareersDataCx };

CareersDataCx.Provider = Provider;
CareersDataCx.use = useContext;
